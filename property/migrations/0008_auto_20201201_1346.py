    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(blank=True, db_index=True,
                                   max_length=200, verbose_name='Текст жалобы'),
        ),
        migrations.AlterField(
            model_name='flat',
            name='new_building',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True,
                                        ...
                                        serialize=False,
                                        verbose_name='ID')),
                ('owner', models.CharField(db_index=True,
                                           max_length=200,
                                           null=True,
                                           verbose_name='ФИО владельца')),
                ('owners_phonenumber', models.CharField(db_index=True,
                                                        max_length=20,
                                                        null=True,
                                                        verbose_name='Номер владельца')),
