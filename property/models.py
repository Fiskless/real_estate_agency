...
class Flat(models.Model):
    ...
    liked_by = models.ManyToManyField("Complaint", verbose_name="Кто лайкнул",
...
class Complaint(User):
    ...
    who_complained = models.ForeignKey(User, on_delete=models.SET_NULL,
    ...
    flat = models.ForeignKey(Flat, on_delete=models.SET_NULL,
                             ...
                             related_name='flat_complained', null=True,
                             blank=True, db_index=True)
    complain_text = models.CharField("Текст жалобы", max_length=200,
                                     blank=True, db_index=True)
...
class Owner(models.Model):
    ...
    owner_flats = models.ManyToManyField("Flat", verbose_name="Квартиры в собственности",
                                         related_name="flats_of_owner", db_index=True)
